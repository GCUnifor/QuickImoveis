...
const properties = [
    {
        ...
        property_type: client_1.PropertyType.APARTAMENTO,
        price: 450_000, area: 68, bedrooms: 2,
        status: client_1.PropertyStatus.DISPONIVEL,
        street: 'Rua Barão de Itapetininga', number: '120',
        neighborhood: 'Centro', city: 'São Paulo', state: brazilian_state_enum_1.BrazilianState.SaoPaulo,
    ...
    },
    {
        ...
        property_type: client_1.PropertyType.CASA,
        price: 650_000, area: 120, bedrooms: 3,
        status: client_1.PropertyStatus.DISPONIVEL,
        street: 'Rua Domingos de Morais', number: '850',
        neighborhood: 'Vila Mariana', city: 'São Paulo', state: brazilian_state_enum_1.BrazilianState.SaoPaulo,
    ...
    },
    {
        ...
        neighborhood: 'Barão Geraldo', city: 'Campinas', state: brazilian_state_enum_1.BrazilianState.SaoPaulo,
    ...
    },
    {
        ...
        property_type: client_1.PropertyType.COMERCIAL,
        price: 520_000, area: 45, bedrooms: 0,
        status: client_1.PropertyStatus.DISPONIVEL,
        street: 'Av. Engenheiro Luís Carlos Berrini', number: '1500',
        neighborhood: 'Brooklin', city: 'São Paulo', state: brazilian_state_enum_1.BrazilianState.SaoPaulo,
    ...
    },
    {
        ...
        property_type: client_1.PropertyType.RURAL,
        price: 750_000, area: 1500, bedrooms: 3,
        status: client_1.PropertyStatus.DISPONIVEL,
        street: 'Estrada Municipal', number: 'Km 8',
        neighborhood: 'Jardim Estância Brasil', city: 'Atibaia', state: brazilian_state_enum_1.BrazilianState.SaoPaulo,
    ...
    },
    {
        ...
        neighborhood: 'Leblon', city: 'Rio de Janeiro', state: brazilian_state_enum_1.BrazilianState.RioDeJaneiro,
    ...
    },
    {
        ...
        neighborhood: 'Copacabana', city: 'Rio de Janeiro', state: brazilian_state_enum_1.BrazilianState.RioDeJaneiro,
    ...
    },
    {
        ...
        status: client_1.PropertyStatus.VENDIDO,
        street: 'Rua Mariz e Barros', number: '310',
        neighborhood: 'Icaraí', city: 'Niterói', state: brazilian_state_enum_1.BrazilianState.RioDeJaneiro,
    ...
    },
    {
        ...
        neighborhood: 'Savassi', city: 'Belo Horizonte', state: brazilian_state_enum_1.BrazilianState.MinasGerais,
    ...
    },
    {
        ...
        neighborhood: 'Centro', city: 'Ouro Preto', state: brazilian_state_enum_1.BrazilianState.MinasGerais,
    ...
    },
    {
        ...
        neighborhood: 'Batel', city: 'Curitiba', state: brazilian_state_enum_1.BrazilianState.Parana,
    ...
    },
    {
        ...
        property_type: client_1.PropertyType.TERRENO,
        price: 195_000, area: 360, bedrooms: 0,
        status: client_1.PropertyStatus.DISPONIVEL,
        street: 'Rua das Araucárias', number: 'Lote 12',
        neighborhood: 'Afonso Pena', city: 'São José dos Pinhais', state: brazilian_state_enum_1.BrazilianState.Parana,
    ...
    },
    {
        ...
        neighborhood: 'Centro', city: 'Balneário Camboriú', state: brazilian_state_enum_1.BrazilianState.SantaCatarina,
    ...
    },
    {
        ...
        neighborhood: 'Trancoso', city: 'Porto Seguro', state: brazilian_state_enum_1.BrazilianState.Bahia,
    ...
    },
    {
        ...
        neighborhood: 'Moinhos de Vento', city: 'Porto Alegre', state: brazilian_state_enum_1.BrazilianState.RioGrandeDoSul,
    ...
    },
    {
        ...
        neighborhood: 'Setor Bueno', city: 'Goiânia', state: brazilian_state_enum_1.BrazilianState.Goias,
    ...
    },
    {
        ...
        neighborhood: 'Asa Sul', city: 'Brasília', state: brazilian_state_enum_1.BrazilianState.DistritoFederal,
    ...
    },
    {
        ...
        neighborhood: 'Boa Viagem', city: 'Recife', state: brazilian_state_enum_1.BrazilianState.Pernambuco,
    ...
    },
    {
        ...
        status: client_1.PropertyStatus.RASCUNHO,
        street: 'Rua Desembargador Moreira', number: '500',
        neighborhood: 'Eusébio', city: 'Eusébio', state: brazilian_state_enum_1.BrazilianState.Ceara,
    ...
    },
    {
        ...
        neighborhood: 'Vila Madalena', city: 'São Paulo', state: brazilian_state_enum_1.BrazilianState.SaoPaulo,
...
async function main() {
    ...
    const corretor = await prisma.user.upsert({
        ...
        create: {
            ...
            name: 'Carlos Mendes',
            role: client_1.UserRole.CORRETOR,
            creci: '12345-F',
            phone: '11999998888',
    ...
    await prisma.userAddress.upsert({
        ...
        create: {
            ...
            city: 'São Paulo',
            state: brazilian_state_enum_1.BrazilianState.SaoPaulo,
            country: 'Brasil',
    ...
    await prisma.userAddress.upsert({
        ...
        create: {
            ...
            city: 'Rio de Janeiro',
            state: brazilian_state_enum_1.BrazilianState.RioDeJaneiro,
            country: 'Brasil',
    ...
    const comprador = await prisma.user.upsert({
        ...
        create: {
            ...
            password: hashedPassword,
            name: 'João Silva',
            role: client_1.UserRole.COMPRADOR,
            is_active: true,
            is_email_verified: true,
            renda_mensal: 8_000,
